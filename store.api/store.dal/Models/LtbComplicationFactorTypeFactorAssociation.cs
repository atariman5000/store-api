...
{
    /// <summary>
    /// This table indicates which complicating factors can be used with the different complicating factor types.
    /// </summary>
    public partial class LtbComplicationFactorTypeFactorAssociation
    {
        ...
        /// <summary>
        /// Unique ID respresenting Complication Factor Type. 
        /// </summary>
        public int ComplicationFactorTypeId { get; set; }
        /// <summary>
        /// Unique ID representing the complication factor.
        /// </summary>
