...
{
    /// <summary>
    /// This table contains the first level of Duty Status values for an individual (On-Duty, Off-Duty).
    /// </summary>
    public partial class LtbDutyStatus
    {
        public LtbDutyStatus()
        {
            ...
            LtbDutyStatusLevel2Associations = new HashSet<LtbDutyStatusLevel2Association>();
        ...
        public virtual ICollection<LtbDutyStatusLevel2Association> LtbDutyStatusLevel2Associations { get; set; }
