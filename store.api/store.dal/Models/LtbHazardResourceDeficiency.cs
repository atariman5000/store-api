...
namespace store.dal.Models
{
    ...
    /// </summary>
    public partial class LtbHazardResourceDeficiency
    {
        public LtbHazardResourceDeficiency()
        {
            InverseHazardResourceDeficiencyParent = new HashSet<LtbHazardResourceDeficiency>();
        }

        /// <summary>
        /// Unique generated number for the record used for row identity.
        /// </summary>
        public int HazardResourceDeficiencyId { get; set; }
        /// <summary>
        /// A code value for the current record.
        /// </summary>
        public string HazardResourceDeficiencyCode { get; set; }
        /// <summary>
        ...
        /// </summary>
        public int? HazardResourceDeficiencyParentId { get; set; }
        /// <summary>
        ...
        public virtual LtbHazardResourceDeficiency HazardResourceDeficiencyParent { get; set; }
        public virtual ICollection<LtbHazardResourceDeficiency> InverseHazardResourceDeficiencyParent { get; set; }
    }
}