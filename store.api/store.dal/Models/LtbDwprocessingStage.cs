...
{
    /// <summary>
    /// This table provides a list of mishap data warehouse processing stages that identify the flow of the mishap through the data warehouse and shows the stage of a mishap at a particular point in time.  Mishap data warehouse processing stages are created and identified internally and are not regulatory. 
    /// </summary>
    public partial class LtbDwprocessingStage
    {
        public LtbDwprocessingStage()
        {
            ...
            LtbMishapStatusDwprocessingStageAssociations = new HashSet<LtbMishapStatusDwprocessingStageAssociation>();
        }
        ...
        public virtual ICollection<LtbMishapStatusDwprocessingStageAssociation> LtbMishapStatusDwprocessingStageAssociations { get; set; }
    }
}