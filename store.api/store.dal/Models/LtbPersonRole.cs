...
{
    /// <summary>
    /// This table provides the various roles a person could have in a mishap, inspection,....
    /// </summary>
    public partial class LtbPersonRole
    {
        public LtbPersonRole()
        {
            ...
            LtbNotificationTypes = new HashSet<LtbNotificationType>();
        }
        ...
        public virtual ICollection<LtbNotificationType> LtbNotificationTypes { get; set; }
    }
}