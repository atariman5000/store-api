...
{
    /// <summary>
    /// This table provides a mapping of specific narratives types to particular personal protective equipment questions.
    /// </summary>
    public partial class LtbPpequestionNarrativeAssociation
    {
        ...
        /// <summary>
        /// The table containing the answer to the associated PPE question.
        /// </summary>
        public string AssociatedTable { get; set; }
        /// <summary>
        /// The column containing the answer to the associated PPE question.
        /// </summary>
        public string AssociatedColumn { get; set; }
        /// <summary>
        /// The response required to the associated question in order for the narrative question to be displayed.
        /// </summary>
        public int? RequiredResponseId { get; set; }
        /// <summary>
        /// The narrative question for the associated PPE question and response.
        /// </summary>
