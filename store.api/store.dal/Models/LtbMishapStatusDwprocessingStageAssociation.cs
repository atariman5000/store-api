...
{
    /// <summary>
    /// This table provides the set of DW Processing Stages that can be set for a given Mishap Status in a mishap.
    /// </summary>
    public partial class LtbMishapStatusDwprocessingStageAssociation
    {
        ...
        /// <summary>
        /// Unique ID representing Mishap Source.
        /// </summary>
        public int MishapSourceId { get; set; }
        /// <summary>
        /// Unique ID representing Mishap Status.
        /// </summary>
        public int MishapStatusId { get; set; }
        /// <summary>
        /// Unique ID representing DW Processing Stage.
        /// </summary>
