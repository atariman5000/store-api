...
{
    /// <summary>
    /// This table provides a self-referencing hierarchy  of federal and non-federal pay grades for both military and civilian personnel.  External Data Source.
    /// </summary>
    public partial class LtbPayGrade
    {
        public LtbPayGrade()
        {
            ...
            LtbPayGradeCivilianJobSeriesAssociations = new HashSet<LtbPayGradeCivilianJobSeriesAssociation>();
            LtbPayGradeMilitaryOccupationSpecialityAssociations = new HashSet<LtbPayGradeMilitaryOccupationSpecialityAssociation>();
            LtbRankPayGradeAssociations = new HashSet<LtbRankPayGradeAssociation>();
        }
        ...
        public virtual ICollection<LtbPayGradeCivilianJobSeriesAssociation> LtbPayGradeCivilianJobSeriesAssociations { get; set; }
        public virtual ICollection<LtbPayGradeMilitaryOccupationSpecialityAssociation> LtbPayGradeMilitaryOccupationSpecialityAssociations { get; set; }
        public virtual ICollection<LtbRankPayGradeAssociation> LtbRankPayGradeAssociations { get; set; }
    }
}