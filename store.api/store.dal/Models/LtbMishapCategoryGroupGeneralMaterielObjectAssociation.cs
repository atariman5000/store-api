...
{
    /// <summary>
    /// This table provides the set of Materiel items that can be selected for a given mishap category group in a mishap within the specialized Materiel screens.
    /// </summary>
