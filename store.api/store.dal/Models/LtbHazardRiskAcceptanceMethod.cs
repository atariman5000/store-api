...
{
    /// <summary>
    /// This table provides a list of hazard report statuses.
    /// </summary>
    public partial class LtbHazardRiskAcceptanceMethod
    {
        public LtbHazardRiskAcceptanceMethod()
        {
            InverseHazardRiskAcceptanceMethodParent = new HashSet<LtbHazardRiskAcceptanceMethod>();
        }

        /// <summary>
        /// Unique generated number for the record used for row identity.
        /// </summary>
        public int HazardRiskAcceptanceMethodId { get; set; }
        /// <summary>
        /// A code value for the current record.
        /// </summary>
        public string HazardRiskAcceptanceMethodCode { get; set; }
        /// <summary>
        ...
        /// </summary>
        public int? HazardRiskAcceptanceMethodParentId { get; set; }
        /// <summary>
        ...
        public virtual LtbHazardRiskAcceptanceMethod HazardRiskAcceptanceMethodParent { get; set; }
        public virtual ICollection<LtbHazardRiskAcceptanceMethod> InverseHazardRiskAcceptanceMethodParent { get; set; }
    }
}