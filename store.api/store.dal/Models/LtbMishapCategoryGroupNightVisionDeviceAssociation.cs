...
{
    /// <summary>
    /// This table provides the set of night vision devices that can be selected for a given mishap category group in a mishap.
    /// </summary>
    public partial class LtbMishapCategoryGroupNightVisionDeviceAssociation
    {
        ...
        /// <summary>
        /// Unique ID representing the night vision device materiel object.
        /// </summary>
        public int NightVisionMaterielObjectId { get; set; }
        /// <summary>
        /// Unique ID representing the personnel duty status.
        /// </summary>
