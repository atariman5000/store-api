...
{
    /// <summary>
    /// This table contains the Modified mission component of the Mission Design Series (MDS) of an Aircraft. Identifies modifications to the Modified mission of an aircraft and appears to the immediate left of the Modified mission symbol. Only one modified mission symbol shall be used in any one MDS. EXAMPLE: AT-38B, Modified Mission A identifies a T-38B modified for attack. Regulatory Guidance DoD 4120.15-L Model Designation of Military Aerospace Vehicles.  External Data Source.
    /// </summary>
    public partial class LtbAircraftMdsmodifiedMission
    {
        ...
        /// <summary>
        /// Code for the Modified mission of the aircraft MDS.
        /// </summary>
