...
{
    /// <summary>
    /// This table contains Personnel Employment status values with self-referencing hierarchy of categories.
    /// </summary>
    public partial class LtbEmploymentStatus
    {
        public LtbEmploymentStatus()
        {
            ...
            LtbEmploymentStatusArmyCountableInjuryAssociations = new HashSet<LtbEmploymentStatusArmyCountableInjuryAssociation>();
            LtbEmploymentStatusDutyStatusAssociations = new HashSet<LtbEmploymentStatusDutyStatusAssociation>();
            LtbEmploymentStatusInjuryDueToArmyOpsAssociations = new HashSet<LtbEmploymentStatusInjuryDueToArmyOpsAssociation>();
            LtbEmploymentStatusPayGradeAssociations = new HashSet<LtbEmploymentStatusPayGradeAssociation>();
            LtbIninjuryCostCategoryMishapPersonAssociations = new HashSet<LtbIninjuryCostCategoryMishapPersonAssociation>();
            LtbInjuryCostCategoryMishapPersonAssociations = new HashSet<LtbInjuryCostCategoryMishapPersonAssociation>();
        }
        ...
        public virtual ICollection<LtbEmploymentStatusArmyCountableInjuryAssociation> LtbEmploymentStatusArmyCountableInjuryAssociations { get; set; }
        public virtual ICollection<LtbEmploymentStatusDutyStatusAssociation> LtbEmploymentStatusDutyStatusAssociations { get; set; }
        public virtual ICollection<LtbEmploymentStatusInjuryDueToArmyOpsAssociation> LtbEmploymentStatusInjuryDueToArmyOpsAssociations { get; set; }
        public virtual ICollection<LtbEmploymentStatusPayGradeAssociation> LtbEmploymentStatusPayGradeAssociations { get; set; }
        public virtual ICollection<LtbIninjuryCostCategoryMishapPersonAssociation> LtbIninjuryCostCategoryMishapPersonAssociations { get; set; }
        public virtual ICollection<LtbInjuryCostCategoryMishapPersonAssociation> LtbInjuryCostCategoryMishapPersonAssociations { get; set; }
    }
}