...
{
    /// <summary>
    /// This table provides the set of Environmental Detail Type data elements/columns that can be selected for a given mishap category group in a mishap.
    /// </summary>
    public partial class LtbMishapCategoryGroupEnvironmentalDetailTypeAssociation
    {
        ...
        /// <summary>
        /// Unique ID representing the environment detail data element associated with mishap category group.
        /// </summary>
