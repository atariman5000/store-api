...
{
    /// <summary>
    /// This table contains environmental measurements that may be recorded in event of a mishap.
    /// </summary>
    public partial class LtbEnvironmentalDetailType
    {
        ...
        /// <summary>
        /// The column name of the environmental data element.
        /// </summary>
        public string ColumnName { get; set; }
        /// <summary>
        /// The minimum value that should be accepted for the environmental data element.
        /// </summary>
        public int? MinValue { get; set; }
        /// <summary>
        /// The maximum value that should be accepted for the environmental data element.
        /// </summary>
