...
namespace store.dal.Models
{
    ...
    /// </summary>
    public partial class LtbHazardActionStatus
    {
        public LtbHazardActionStatus()
        {
            InverseHazardActionStatusParent = new HashSet<LtbHazardActionStatus>();
        }

        /// <summary>
        /// Unique generated number for the record used for row identity.
        /// </summary>
        public int HazardActionStatusId { get; set; }
        /// <summary>
        /// A code value for the current record.
        /// </summary>
        public string HazardActionStatusCode { get; set; }
        /// <summary>
        ...
        /// </summary>
        public int? HazardActionStatusParentId { get; set; }
        /// <summary>
        ...
        public virtual LtbHazardActionStatus HazardActionStatusParent { get; set; }
        public virtual ICollection<LtbHazardActionStatus> InverseHazardActionStatusParent { get; set; }
    }
}