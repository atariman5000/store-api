...
{
    /// <summary>
    /// This table provides the general condition of the surface on a large body of water with respect to wind waves and swell.  These values are a subset of the Douglas Sea Scale, which is a scale that measures the height of waves and also measures the swell of 
    /// </summary>
