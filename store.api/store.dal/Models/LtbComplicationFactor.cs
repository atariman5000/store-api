...
{
    /// <summary>
    /// This table provides a list of factors that could complicate survival or rescue operations in a mishap.
    /// </summary>
    public partial class LtbComplicationFactor
    {
        public LtbComplicationFactor()
        {
            ...
            LtbComplicationFactorTypeFactorAssociations = new HashSet<LtbComplicationFactorTypeFactorAssociation>();
        }
        ...
        public virtual ICollection<LtbComplicationFactorTypeFactorAssociation> LtbComplicationFactorTypeFactorAssociations { get; set; }
    }
}