...
{
    /// <summary>
    /// This table provides a list of mishap report status values that identify the state of a mishap report at a particular point in time during its flow through the mishap reporting tool.   Mishap Report status values are created and identified internally and are not regulatory.
    /// </summary>
