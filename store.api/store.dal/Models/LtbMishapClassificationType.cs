...
{
    /// <summary>
    /// This table contains a listing of mishap classification types used to define mishap classifications per AR 385-10, AR 385-40 and DA PAM 385-40 (accident, incident,…).
    /// </summary>
    public partial class LtbMishapClassificationType
    {
        public LtbMishapClassificationType()
        {
            ...
            LtbMishapClassifications = new HashSet<LtbMishapClassification>();
        }
        ...
        public virtual ICollection<LtbMishapClassification> LtbMishapClassifications { get; set; }
    }
}