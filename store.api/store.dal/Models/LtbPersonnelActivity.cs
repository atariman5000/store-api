...
{
    /// <summary>
    /// This table provides the potential set of personnel activities or duty positions that a person could be engaged in at the time of the mishap.
    /// </summary>
    public partial class LtbPersonnelActivity
    {
        public LtbPersonnelActivity()
        {
            ...
            LtbAircraftDesignationPersonnelActivityAssociations = new HashSet<LtbAircraftDesignationPersonnelActivityAssociation>();
            LtbDutyPositionDutyPositionRatingAssociations = new HashSet<LtbDutyPositionDutyPositionRatingAssociation>();
            LtbDutyPostionExperienceCollecteds = new HashSet<LtbDutyPostionExperienceCollected>();
            LtbMishapCategoryGroupPersonnelActivityAssociations = new HashSet<LtbMishapCategoryGroupPersonnelActivityAssociation>();
            LtbPersonnelActivityUasseatPositionAssociations = new HashSet<LtbPersonnelActivityUasseatPositionAssociation>();
        }
        ...
        public virtual ICollection<LtbAircraftDesignationPersonnelActivityAssociation> LtbAircraftDesignationPersonnelActivityAssociations { get; set; }
        ...
        public virtual ICollection<LtbDutyPostionExperienceCollected> LtbDutyPostionExperienceCollecteds { get; set; }
        ...
        public virtual ICollection<LtbPersonnelActivityUasseatPositionAssociation> LtbPersonnelActivityUasseatPositionAssociations { get; set; }
    }
}