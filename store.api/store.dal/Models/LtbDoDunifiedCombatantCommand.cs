...
{
    /// <summary>
    /// This table contain Department of Defense Unified Combatant Commands (UCC).  UCC is a US DoD command composed of forces from at least two Military Departments.  These commands are established to provide effective command and control of US military forces, regardless of branch of service, in peace and war.  They are organized either on geographical basis known as Area of Responsibility (AOR) or on functional basis.  UCCs are joint commands with specific badges denoting affiliation. Supporting DOD information.  External Data Source.
    /// </summary>
    public partial class LtbDoDunifiedCombatantCommand
    {
        ...
        /// <summary>
        /// Unique ID representing the DoD Unified Combatant Roles.
        /// </summary>
        public int DoDunifiedCombatantRoleId { get; set; }
        /// <summary>
        /// Department of Defense (DoD) Installation Headquarters
        /// </summary>
