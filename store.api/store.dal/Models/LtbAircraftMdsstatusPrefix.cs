...
{
    /// <summary>
    /// This table contains a listing of the status prefix component of the Mission Design Series (MDS) of an Aircraft. Status Prefix is an optional prefix to show that an aerospace vehicle is not standard because of its test, modification, experimental, or prototype design. For aircraft, the symbol appears to the immediate left of the modified mission symbol or basic mission symbol. Regulatory Guidance DoD 4120.15-L Model Designation of Military Aerospace Vehicles.  External Data Source.
    /// </summary>
    public partial class LtbAircraftMdsstatusPrefix
    {
        public LtbAircraftMdsstatusPrefix()
        {
            ...
            LtbAircraftMtds = new HashSet<LtbAircraftMtd>();
        }
        ...
        /// <summary>
        /// Code for the status prefix of the aircraft MDS.
        /// </summary>
        ...
        public virtual ICollection<LtbAircraftMtd> LtbAircraftMtds { get; set; }
    }
}