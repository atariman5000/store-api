...
{
    /// <summary>
    /// This table contains a collection of forms and IDs used by the application.
    /// </summary>
    public partial class LtbApplicationForm
    {
        public LtbApplicationForm()
        {
            ...
            LtbApplicationQuestions = new HashSet<LtbApplicationQuestion>();
        }
        ...
        public virtual ICollection<LtbApplicationQuestion> LtbApplicationQuestions { get; set; }
    }
}