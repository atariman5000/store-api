...
{
    /// <summary>
    /// This table provides the set of Aircraft MTDS that can be selected for a given mishap category group in a mishap.
    /// </summary>
    public partial class LtbMishapCategoryGroupAircraftMtdsassociation
    {
        ...
        public virtual LtbAircraftMtd AircraftMtds { get; set; }
