...
{
    /// <summary>
    /// This table provides a self-referencing hierarchy of application modules.
    /// </summary>
    public partial class LtbApplicationModule
    {
        public LtbApplicationModule()
        {
            ...
            LtbApplicationModuleElementAssociations = new HashSet<LtbApplicationModuleElementAssociation>();
            LtbApplicationModuleMishapCategoryGroupDisplayOrders = new HashSet<LtbApplicationModuleMishapCategoryGroupDisplayOrder>();
            LtbAsmisapplicationModuleAssociations = new HashSet<LtbAsmisapplicationModuleAssociation>();
        ...
        public virtual ICollection<LtbApplicationModuleElementAssociation> LtbApplicationModuleElementAssociations { get; set; }
        ...
        public virtual ICollection<LtbAsmisapplicationModuleAssociation> LtbAsmisapplicationModuleAssociations { get; set; }
