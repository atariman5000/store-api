...
{
    /// <summary>
    /// This table provides the mishap criteria to determine the Mishap Initial Due Date.
    /// </summary>
    public partial class LtbMishapInitialDueDateCriterion
    {
        /// <summary>
        ...
        /// <summary>
        /// Mishap Classification of the Mishap (A - F).
        /// </summary>
        public string MishapClassification { get; set; }
        /// <summary>
        /// Unique ID representing Mishap Category Group of the Mishap.
        /// </summary>
        public int MishapCategoryGroupId { get; set; }
        /// <summary>
        /// Unique ID representing the Mishap Duty Status of the Mishap.
        /// </summary>
        public int MishapDutyStatusId { get; set; }
        /// <summary>
        /// Unique ID representing the Mission Type of the Mishap.
        /// </summary>
        public int MissionTypeId { get; set; }
        /// <summary>
        /// Unique ID representing the Mishap Source of the Mishap.
        /// </summary>
        public int MishapSourceId { get; set; }
        /// <summary>
        /// Unique ID representing whether an Investigation is required.
        /// </summary>
        public int InvestigationRequiredResponseId { get; set; }
        /// <summary>
        /// The number of days to be added to the mishap date to determine the initial due date.
        /// </summary>
