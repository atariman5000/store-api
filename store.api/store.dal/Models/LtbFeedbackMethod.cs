...
namespace store.dal.Models
{
    ...
    /// </summary>
    public partial class LtbFeedbackMethod
    {
        public LtbFeedbackMethod()
        {
            InverseFeedbackMethodParent = new HashSet<LtbFeedbackMethod>();
        }

        /// <summary>
        /// Unique generated number for the record used for row identity.
        /// </summary>
        public int FeedbackMethodId { get; set; }
        /// <summary>
        /// A code value for the current record.
        /// </summary>
        public string FeedbackMethodCode { get; set; }
        /// <summary>
        ...
        /// </summary>
        public int? FeedbackMethodParentId { get; set; }
        /// <summary>
        ...
        public virtual LtbFeedbackMethod FeedbackMethodParent { get; set; }
        public virtual ICollection<LtbFeedbackMethod> InverseFeedbackMethodParent { get; set; }
    }
}