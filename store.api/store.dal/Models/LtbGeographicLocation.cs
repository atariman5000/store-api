...
{
    /// <summary>
    /// This table contains Geographic Locations in accordance with DRRS/Asorts and Army Location File. External Data Source.
    /// </summary>
    public partial class LtbGeographicLocation
    {
        public LtbGeographicLocation()
        {
            LtbUicdetailHomeGeographicLocations = new HashSet<LtbUicdetail>();
            LtbUicdetailPresentGeographicLocations = new HashSet<LtbUicdetail>();
        }
        ...
        /// <summary>
        /// Unique ID representing the country.
        /// </summary>
        ...
        public virtual ICollection<LtbUicdetail> LtbUicdetailHomeGeographicLocations { get; set; }
        public virtual ICollection<LtbUicdetail> LtbUicdetailPresentGeographicLocations { get; set; }
    }
}