...
{
    /// <summary>
    /// This table provides a list of recommendation conditions determined during RTS evaluation (valid, supported, properly targeted; valid, supported, not properly targeted;….).
    /// </summary>
    public partial class LtbRecommendationCondition
    {
        public LtbRecommendationCondition()
        {
            ...
            LtbRecommendationConditionRecStatusAssociations = new HashSet<LtbRecommendationConditionRecStatusAssociation>();
        }
        ...
        public virtual ICollection<LtbRecommendationConditionRecStatusAssociation> LtbRecommendationConditionRecStatusAssociations { get; set; }
    }
}