...
{
    /// <summary>
    /// This table provides a list of assemment values that are used for a finding (Causal, Contributing to Severity Injury/Damage, Present but not Causal, Known but not extracted).
    /// </summary>
