...
{
    /// <summary>
    /// This table provides a list of the recommendation target(agency) states for Army Level Recommendations (Mishap original, Mishap original removed, RTS revision,…).  
    /// </summary>
